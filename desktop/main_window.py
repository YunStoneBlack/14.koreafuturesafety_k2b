...
class MainWindow(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        # 창을 최대화하지 않아도 "실행" 버튼이 항상 보이도록, 위쪽 입력 카드들만
        # 스크롤 영역에 담고 실행 버튼/안내문구는 스크롤 밖 하단에 고정한다
        # (예전엔 전부 한 레이아웃에 있어서 창이 작으면 버튼이 화면 밖으로 밀려났음).
        scroll = QScrollArea()
    ...
    def _run_automation(self) -> None:
        ...
        self._apply_manual_fields(self._current_data)
